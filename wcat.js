...
// 2)--> node wcat.js filepath1 filepath2 filepath3  => displays the content.
// of all files in terminal in concatinated form in given order
...
for (let i = 0; i < filesArr.length; i++) {
  ...
  if (!doesExist) {
    ...
    // return;
process.exit(); // --> clearends the process
  }
}
...
//====== < push everything is temparray except null > =======
let isSPresent = optionsArr.includes("-s");//.inckude search data in array when you want data 
if (isSPresent) {
